...
const Aboutus = () => {
    ...
    },
    {
        ...
        img: "/images/Aboutus/aboutus/compressed/goals_11zon.webp"
    },
    ]
    const seedsArray = [
        { title: "MIONP", img: "/images/Aboutus/aboutus/compressed/MIONP_11zon.webp" },
        { title: "Edu Astra ", img: "/images/Aboutus/aboutus/compressed/Astra_11zon.webp" },
        { title: "Integrated Ayush", img: "/images/Aboutus/aboutus/compressed/Integrated_11zon.webp" },
        { title: "Startup KY", img: "/images/Aboutus/aboutus/compressed/Startup_11zon.webp" },
        { title: "Garbhavidhya ", img: "/images/Aboutus/aboutus/compressed/Garbhavidhya_11zon.webp" },
        { title: "Yuva Shakti", img: "/images/Aboutus/aboutus/compressed/Yuva_11zon.webp" },
        { title: "Naari Shakti", img: "/images/Aboutus/aboutus/compressed/Naari_11zon.webp" },
        { title: "Renewable Energy", img: "/images/Aboutus/aboutus/compressed/Renewable_11zon.webp" },
        { title: "Digital Marketplace", img: "/images/Aboutus/aboutus/compressed/Digital_11zon.webp" },
    ]
    const people = [
        { name: "Vikas Bansal", img: "/images/Aboutus/aboutus/compressed/Vikas_11zon.webp" },
        { name: "Manoj Kumar", img: "/images/Aboutus/aboutus/compressed/Manoj_11zon.webp" },
        { name: "Moon Goel", img: "/images/Aboutus/aboutus/compressed/Moon_11zon.webp" },
        { name: "Naveen Verma", img: "/images/Aboutus/aboutus/compressed/Naveen_11zon.webp" },
        { name: "Kabir Sahni ", img: "/images/Aboutus/aboutus/compressed/Kabir_11zon.webp" },
        { name: "Kandaswamy Natarajan", img: "/images/Aboutus/aboutus/compressed/Kandaswamy_11zon.webp" },
        { name: "Krishna Thakur", img: "/images/Aboutus/aboutus/compressed/Krishna_11zon.webp" },
    ]
    return (
        <>
            <Nav />
            <div className="w-full h-screen bg-[url('/images/Aboutus/aboutus/compressed/aboutushero_11zon.webp')] bg-cover bg-center text-white center px-5 md:px-20">
            ...
            <div className="roots-global w-full h-fit px-5 py-10 lg:flex lg:gap-20 lg:px-10">
                <div className="img-container w-full h-[40vh] lg:h-[50vh] rounded-md overflow-hidden">
                    <img className='w-full h-full bg-cover' src="/images/Aboutus/aboutus/compressed/roots_11zon.webp" alt="" />
                </div>
                ...
                <div className="lg:flex lg:flex-row-reverse">
                    <div className="relative mission-imgs w-full h-[70vh] overflow-hidden">
                        <div className="square absolute top-[30%] lg:top-[20%] left-[40%] -translate-x-1/2 -translate-y-1/2 rotate-45 size-20 md:size-32 lg:size-40 rounded-lg overflow-hidden">
                            <img className='w-full h-full object-cover' src={"/images/Aboutus/aboutus/compressed/m1_11zon.webp"} alt="" /></div>
                        <div className="square absolute top-[50%] left-[17%] -translate-x-1/2 -translate-y-1/2 rotate-45 size-20 md:size-32 lg:size-40 rounded-lg overflow-hidden">
                            <img className='size-full object-cover' src={"/images/Aboutus/aboutus/compressed/m2_11zon.webp"} alt="" /></div>
                        <div className="square absolute top-[70%] lg:top-[80%] left-[40%] -translate-x-1/2 -translate-y-1/2 rotate-45 size-20 md:size-32 lg:size-40 rounded-lg overflow-hidden">
                            <img className='size-full object-cover' src={"/images/Aboutus/aboutus/compressed/m3_11zon.webp"} alt="" /></div>
                        <div className="square absolute top-[50%] left-[100%] -translate-x-1/2 -translate-y-1/2 -rotate-45 size-56 md:size-96 rounded-2xl border-2 border-black overflow-hidden">
                            <img className='size-full object-cover' src={"/images/Aboutus/aboutus/compressed/bigsquare_11zon.webp"} alt="" /></div>
                    </div>
            ...
            <div className="w-full h-[50vh] max-[600px]:h-[40vh] bg-[url('/images/Aboutus/aboutus/compressed/delhibg_11zon.webp')] bg-cover max-[600px]:bg-[url('/images/Aboutus/aboutus/compressed/delhimobilebg_11zon.webp')] max-[600px]:bg-contain bg-no-repeat bg-center"></div>
