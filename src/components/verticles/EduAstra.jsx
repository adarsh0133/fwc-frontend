    ...
    const cards = [
        {
            ...
            image: "/images/vertices/eduastra/edu.webp",
        },
        {
            ...
            image: "/images/vertices/eduastra/Bot.webp",
        },
        {
            ...
            image: "/images/vertices/eduastra/Brain.webp",
        },
    ]
    return (
        <>
            ...
            <div className="w-full h-fit px-5 pt-28 pb-5 lg:flex lg:px-10 lg:pt-40 lg:pb-20  ">
                <div className="hero-text lg:w-1/2 lg:px-10">
                    ...
                    <ul className="mt-4 space-y-4 font-normal text-sm leading-tight lg:text-lg">
                        <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-0 before:w-5 before:h-5 before:bg-[url('/images/vertices/eduastra/CheckMark.webp')] before:bg-contain before:bg-no-repeat">
                ...
                <div className="hero-image mt-10 lg:w-1/2 lg:mt-0 lg:px-10 overflow-hidden">
                    <img src="/images/vertices/eduastra/heroimg.webp" alt="EduAstra" className='w-full h-full object-cover' />
                </div>
            </div>
                    ...
                    <div className="text-wrapper w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:px-12 lg:gap-20 mt-10 gap-5">
                        <div className="w-full flex ">
                            <div className="img-container w-[25%] px-4 pt-1">
                                <img className='w-[70%]' src="/images/vertices/eduastra/laptop.webp" alt="" />
                            </div>
                            <div className="w-[75%]">
            ...
            <div className="program w-full h-fit text-white bg-[#020F2F] px-5 py-10">
                ...
                <div className="cards-wrapper w-full py-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:p-20 lg:gap-20 gap-5">
                    <div className="w-full flex flex-col gap-3 p-5 bg-white text-black rounded-md">
                        <div className="w-full flex ">
                            <div className="img-container w-[25%] lg:w-[20%] pt-1 lg:pt-0 lg:mb-4">
                                <img className='w-[70%] lg:w-[60%]' src="/images/vertices/eduastra/bbot.webp" alt="" />
                            </div>
                            <div className="w-[75%]">
                        ...
                        <div className="img-container w-full h-[20vh] lg:h-[30vh] rounded-md overflow-hidden">
                            <img className='w-full h-full object-cover' src={"/images/vertices/eduastra/village.webp"} alt="" />
                        </div>
                    ...
                    <div className="w-full flex flex-col gap-3 p-5 bg-white text-black rounded-md">
                        <div className="w-full flex ">
                            <div className="img-container w-[25%] lg:w-[20%] pt-1 lg:pt-0 lg:mb-4">
                                <img className='w-[70%] lg:w-[60%]' src="/images/vertices/eduastra/div.webp" alt="" />
                            </div>
                            <div className="w-[75%]">
                        ...
                        <div className="img-container w-full h-[20vh] lg:h-[30vh] rounded-md overflow-hidden">
                            <img className='w-full h-full object-cover' src={"/images/vertices/eduastra/karma.webp"} alt="" />
                        </div>
                        <ul className="mt-4 space-y-2 font-normal text-sm leading-tight">
                            <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-0 before:w-5 before:h-5 before:bg-[url('/images/vertices/eduastra/CheckMark.webp')] before:bg-contain before:bg-no-repeat">
            ...
            <div className="scholar w-full h-fit bg-white px-5 md:px-10 py-10">
                ...
                <div className="img-container w-full md:h-[50vh] lg:h-[60vh] my-5">
                    <img className='w-full h-full object-cover' src="/images/vertices/eduastra/Rectangle.webp" alt="" />
                </div>
                ...
                <ul className="mt-4 space-y-4 font-normal text-sm leading-tight">
                    <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-0 before:w-5 before:h-5 before:bg-[url('/images/vertices/eduastra/cap.webp')] before:bg-contain before:bg-no-repeat">
                        Financial aid for talented students
                    </li>
                    <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-0 before:w-5 before:h-5 before:bg-[url('/images/vertices/eduastra/globe.webp')] before:bg-contain before:bg-no-repeat">
                        Global networking & academic exposure
                    </li>
                    <li className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-1 before:w-5 before:h-5 before:bg-[url('/images/vertices/eduastra/st.webp')] before:bg-contain before:bg-no-repeat">
